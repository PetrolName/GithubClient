 ...
 *  Describe:
 */
private const val SP_GITHUB = "sp_github"

@JvmOverloads
fun <T> getSpValue(
    filename: String = SP_GITHUB,
    context: Context,
    key: String,
    defaultVal: T
): T {
...
@JvmOverloads
fun removeSpValue(filename: String = SP_GITHUB, context: Context, key: String) {
...
@JvmOverloads
fun clearSpValue(filename: String = SP_GITHUB, context: Context) {
    context.getSharedPreferences(filename, Context.MODE_PRIVATE)
        .edit()
        .clear()
        .apply()
